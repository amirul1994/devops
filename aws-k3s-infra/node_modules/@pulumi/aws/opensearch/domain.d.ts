...
export declare class Domain extends pulumi.CustomResource {
     ...
     */
    readonly offPeakWindowOptions: pulumi.Output<outputs.opensearch.DomainOffPeakWindowOptions>;
    /**
     ...
     */
    readonly softwareUpdateOptions: pulumi.Output<outputs.opensearch.DomainSoftwareUpdateOptions>;
    /**
