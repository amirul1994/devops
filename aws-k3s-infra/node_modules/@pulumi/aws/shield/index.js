...
exports.Subscription = exports.ProtectionHealthCheckAssociation = exports.ProtectionGroup = exports.Protection = exports.ProactiveEngagement = exports.DrtAccessRoleArnAssociation = exports.DrtAccessLogBucketAssociation = exports.ApplicationLayerAutomaticResponse = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.ApplicationLayerAutomaticResponse = null;
utilities.lazyLoad(exports, ["ApplicationLayerAutomaticResponse"], () => require("./applicationLayerAutomaticResponse"));
exports.DrtAccessLogBucketAssociation = null;
utilities.lazyLoad(exports, ["DrtAccessLogBucketAssociation"], () => require("./drtAccessLogBucketAssociation"));
exports.DrtAccessRoleArnAssociation = null;
utilities.lazyLoad(exports, ["DrtAccessRoleArnAssociation"], () => require("./drtAccessRoleArnAssociation"));
exports.ProactiveEngagement = null;
utilities.lazyLoad(exports, ["ProactiveEngagement"], () => require("./proactiveEngagement"));
exports.Protection = null;
utilities.lazyLoad(exports, ["Protection"], () => require("./protection"));
exports.ProtectionGroup = null;
utilities.lazyLoad(exports, ["ProtectionGroup"], () => require("./protectionGroup"));
exports.ProtectionHealthCheckAssociation = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "aws:shield/applicationLayerAutomaticResponse:ApplicationLayerAutomaticResponse":
                return new exports.ApplicationLayerAutomaticResponse(name, undefined, { urn });
            case "aws:shield/drtAccessLogBucketAssociation:DrtAccessLogBucketAssociation":
                return new exports.DrtAccessLogBucketAssociation(name, undefined, { urn });
            case "aws:shield/drtAccessRoleArnAssociation:DrtAccessRoleArnAssociation":
                return new exports.DrtAccessRoleArnAssociation(name, undefined, { urn });
            case "aws:shield/proactiveEngagement:ProactiveEngagement":
                return new exports.ProactiveEngagement(name, undefined, { urn });
            case "aws:shield/protection:Protection":
                return new exports.Protection(name, undefined, { urn });
            case "aws:shield/protectionGroup:ProtectionGroup":
                return new exports.ProtectionGroup(name, undefined, { urn });
            case "aws:shield/protectionHealthCheckAssociation:ProtectionHealthCheckAssociation":
                return new exports.ProtectionHealthCheckAssociation(name, undefined, { urn });
